...
BEGIN
    ...
    ;WITH C AS (
      SELECT 1 Priority, u.user_n UserId, COALESCE(NULLIF(u.ho_ten_nv,N''),u.user_n) DisplayName,
        u.ma_role RoleCode, u.chuc_danh JobTitle, u.ma_bophan DepartmentCode, u.ma_bravo_bophan BravoDepartmentCode, u.ten_bravo_bophan BravoDepartmentName
    ...
    SELECT TOP (1) c.UserId,c.DisplayName,RoleCode=COALESCE(NULLIF(c.RoleCode,N''),N'UNASSIGNED'),
      RoleName=r.ten_phan_quyen,c.JobTitle,c.DepartmentCode,c.BravoDepartmentCode,c.BravoDepartmentName
