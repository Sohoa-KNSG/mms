...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Ghi nhận giao dịch giảm tồn lô cha (Mã chuẩn SPLIT_OUT, logic = -1, số lượng luôn dương)
        ...
        -- C. Ghi nhận giao dịch tăng tồn lô con mới (Mã chuẩn SPLIT_IN, logic = 1, số lượng luôn dương)
        IF @actual_quantity > 0
        BEGIN
            INSERT INTO dbo.tbl_transaction (id_batch, nghiep_vu, id_vattu, id_bravo, ten_vattu, so_luong, unit, time_cre, trang_thai)
