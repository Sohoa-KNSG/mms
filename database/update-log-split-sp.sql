...
-- LƯU Ý NGHIỆP VỤ: Trong quá trình đếm kiểm kê & tách batch in tem, KHÔNG ghi 
-- nhận vào tbl_transaction. Giao dịch biến động kiểm kê chỉ được ghi nhận chính 
-- thức khi Quản đốc / Thủ kho hoàn tất xác nhận duyệt kiểm kê (finish_cycle_count).
-- ============================================================================
