...
- `dbo.tbl_dm_user`: Lưu thông tin tài khoản, mật khẩu, mã nhân viên (`msnv`), họ tên, trạng thái.
- `api.vw_SEC_UserScreenAccess_v1`: View phân quyền màn hình theo UserId.
